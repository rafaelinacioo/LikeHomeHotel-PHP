            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">BEM-VINDO</h6>
                </div>
                <div class="card-body">
                  <div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="img/undraw_posting_photo.svg" alt="">
                  </div>
                  <p>A Reconhecemos que estes são tempos perturbadores e se você está viajando agora ou no futuro, queremos que saiba que sua segurança e bem-estar são nossa primeira prioridade.

                    Sempre que viaja, estamos esperando com portas abertas e corações abertos para fazer com que você se sinta em sua casa </p>
                </div>
              </div>
